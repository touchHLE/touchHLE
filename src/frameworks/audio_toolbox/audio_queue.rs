...
pub fn log_if_broken_audio_format(format: &AudioStreamBasicDescription) {
    ...
    let actual_frames_per_packet = format.bytes_per_packet / format.bytes_per_frame;
    if actual_bytes_per_frame != format.bytes_per_packet
        || actual_frames_per_packet != format.frames_per_packet
    {
        log!(
