...
- (instancetype)initWithCoder:(NSCoder *)coder {
  self = [super init];
  buffer = [coder decodeBytesForKey:[NSString stringWithUTF8String:"buffer"] returnedLength:&length];
  return self;
}
@end
...
int test_NSKeyedArchiver_NSKeyedUnarchiver() {
  ...
  CharBufferObject *obj = [[CharBufferObject alloc] initWithBytes:buffer length:100];
  NSData *archivedData = [NSKeyedArchiver archivedDataWithRootObject:obj];
  CharBufferObject *unarchivedObj = [NSKeyedUnarchiver unarchiveObjectWithData:archivedData];
