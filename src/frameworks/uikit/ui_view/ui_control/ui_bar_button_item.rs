...
use crate::objc::{
    id, impl_HostObject_with_superclass, msg_super, objc_classes, ClassExports, NSZonePtr,
};
...
impl Default for UIBarButtonItemHostObject {
    fn default() -> Self {
        Self {
            ...
            title: crate::objc::nil,
            style: crate::objc::nil,
            target: crate::objc::nil,
            action: crate::objc::nil,
            system_item: 0,
        }
    }
}
...
pub const CLASSES: ClassExports = objc_classes! {
    ...
    - (())dealloc {
        ...
        log_dbg!("Deallocating UIBarButtonItem: title {:?}, target {:?}", title, target);
