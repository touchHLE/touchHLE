...
use crate::objc::{ClassExports, HostObject, NSZonePtr, autorelease, id, objc_classes};
...
+ (id)functionWithName:(CAMediaTimingFunctionName)name {
    ...
    let object: id = match &*name_string {
        kCAMediaTimingFunctionDefault => msg_class![env; _touchHLE_CAMediaTimingFunctionDefault new],
        kCAMediaTimingFunctionEaseIn => msg_class![env; _touchHLE_CAMediaTimingFunctionEaseIn new],
        kCAMediaTimingFunctionEaseInEaseOut => msg_class![env; _touchHLE_CAMediaTimingFunctionEaseInEaseOut new],
        kCAMediaTimingFunctionEaseOut => msg_class![env; _touchHLE_CAMediaTimingFunctionEaseOut new],
        kCAMediaTimingFunctionLinear => msg_class![env; _touchHLE_CAMediaTimingFunctionLinear new],
...
@implementation _touchHLE_CAMediaTimingFunctionDefault: CAMediaTimingFunction

- (id)init {
    msg![env; this initWithControlPoints: 0.25f32 : 0.10f32 : 0.25f32 : 1.00f32]
}

@end

@implementation _touchHLE_CAMediaTimingFunctionEaseIn: CAMediaTimingFunction

- (id)init {
    msg![env; this initWithControlPoints: 0.42f32 : 0.0f32 : 1.0f32 : 1.0f32]
}

@end

@implementation _touchHLE_CAMediaTimingFunctionEaseInEaseOut: CAMediaTimingFunction

- (id)init {
    msg![env; this initWithControlPoints: 0.42f32 : 0.0f32 : 0.58f32 : 1.0f32]
}

@end

@implementation _touchHLE_CAMediaTimingFunctionEaseOut: CAMediaTimingFunction

- (id)init {
    msg![env; this initWithControlPoints: 0.0f32 : 0.0f32 : 0.58f32 : 1.0f32]
}

@end

@implementation _touchHLE_CAMediaTimingFunctionLinear: CAMediaTimingFunction

- (id)init {
    msg![env; this initWithControlPoints: 0.0f32 : 0.0f32 : 1.0f32 : 1.0f32]
}
...
mod tests {
    ...
    fn test_linear_solve_for_input() {
        ...
        };
        {
            ...
            let expected = 0.0; 
            assert!((solution - expected).abs() < 0.0001, "For input {} value {}, expected {}", input, solution, expected);
        }
        {
            let input = 0.25;
            let solution = easeInEaseOut.solve_for_input(input);
