...
- (void)test13 {
  ...
  CAMediaTimingFunction *easeInEaseOut = [CAMediaTimingFunction functionWithName: [NSString stringWithUTF8String:"kCAMediaTimingFunctionEaseInEaseOut"]];
  CAMediaTimingFunction *easeOut = [CAMediaTimingFunction functionWithName: [NSString stringWithUTF8String:"kCAMediaTimingFunctionEaseOut"]];
