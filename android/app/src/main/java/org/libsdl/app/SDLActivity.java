// This is a modified version an SDL project file (available at
// ./android-project/app/src/main/java/org/libsdl/app/ relative to the
// SDL root directory), and retains it's licensing terms, which are
// copied below.
        ...
        if (mNextNativeState == NativeState.RESUMED) {
            if (mSurface.mIsSurfaceReady && mHasFocus && mIsResumedCalled) {
                if (mSDLThread == null) {
                    ...
                    // This line is the only changed one.
                    mSDLThread = new Thread(Thread.currentThread().getThreadGroup(), new SDLMain(), "SDLThread", 1 << 20 * 16);
