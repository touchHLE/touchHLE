...
///
/// In effect, this is basically just a [`Option<Box<T>>`] where dereferencing
/// None is unsafe.
///
...
///
/// As it is now, this will directly dereference the inner pointer in release
/// builds for better performance, even if it is null. It does check in debug
/// builds, but this is purely for debugging purposes and should not be
/// allowed in release code.
