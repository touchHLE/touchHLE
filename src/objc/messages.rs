...
pub(super) fn objc_msgSend(env: &mut Environment, receiver: id, selector: SEL) {
    objc_msgSend_inner(
        env, receiver, selector, /* super2: */ None, /* type_checking: */ true,
    )
}

#[allow(non_snake_case)]
pub(crate) fn _touchHLE_objc_msgSend_no_type_checking(
    env: &mut Environment,
    receiver: id,
    selector: SEL,
) {
    objc_msgSend_inner(
        env, receiver, selector, /* super2: */ None, /* type_checking: */ false,
    )
}
    ...
    R: GuestRet,
{
    ...
    (_touchHLE_objc_msgSend_no_type_checking as fn(&mut Environment, id, SEL))
