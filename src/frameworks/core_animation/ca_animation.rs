...
pub fn has_animation_started(env: &mut Environment, animation: id) -> bool {
    env.objc.borrow::<CAAnimationHostObject>(animation).started
}

pub fn set_animation_started(env: &mut Environment, animation: id) {
    env.objc
