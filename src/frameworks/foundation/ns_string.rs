...
use crate::mem::{guest_size_of, ConstPtr, Mem, MutPtr, Ptr, SafeRead, ConstVoidPtr};
use crate::objc::{
...
impl StringHostObject {
    fn decode(bytes: Cow<[u8]>, encoding: NSStringEncoding) -> StringHostObject {
        ...
        match encoding {
            NSUTF8StringEncoding | NSASCIIStringEncoding => { // There are apps that say ascii and mean utf-8
