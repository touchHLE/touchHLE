...
- (void)test13 {
  UILabel *label = [[[UILabel alloc] initWithFrame:CGRectMake(75,75,175,175)] autorelease];
  ...
  CAMediaTimingFunction *easeInEaseOut = [CAMediaTimingFunction functionWithName: [NSString stringWithUTF8String:"easeInEaseOut"]];
  CAMediaTimingFunction *easeOut = [CAMediaTimingFunction functionWithName: [NSString stringWithUTF8String:"easeOut"]];

  CABasicAnimation *animation = [CABasicAnimation animationWithKeyPath:[NSString stringWithUTF8String:"opacity"]];
  [animation setTimingFunction: easeInEaseOut];
  [animation setDuration: 3.0];
  [animation setFromValue: [NSNumber numberWithFloat: 0.0]];
  [animation setToValue: [NSNumber numberWithFloat: 1.0]];
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"opacity_animation"]];

  animation = [CABasicAnimation animationWithKeyPath:[NSString stringWithUTF8String:"backgroundColor"]];
  ...
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"bg_animation"]];
  ...
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"bg_animation2"]];

  animation = [CABasicAnimation animationWithKeyPath:[NSString stringWithUTF8String:"bounds"]];
  ...
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"bounds_animation"]];

  animation = [CABasicAnimation animationWithKeyPath:[NSString stringWithUTF8String:"cornerRadius"]];
  [animation setDuration: 6.0];
  [animation setFromValue: [NSNumber numberWithFloat: 0.0]];
  [animation setToValue: [NSNumber numberWithFloat: 32.0]];
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"corner_animation"]];

  animation = [CABasicAnimation animationWithKeyPath:[NSString stringWithUTF8String:"position"]];
  [animation setTimingFunction: easeOut];
  ...
  [layer addAnimation:animation forKey:[NSString stringWithUTF8String:"position_animation"]];

  // Remove animation that doesn't exist
  [layer removeAnimationForKey:[NSString stringWithUTF8String:"non_existent_animation"]];
}
@end
