...
fn substitute_classes(
    ...
    // from various third-party advertising or social network SDKs. Naturally it
    // makes a lot of use of UIKit and networking in ways we don't support yet.
    // This isn't "ad blocking" because ads no longer work on real devices anyway :)
