...
- (NSUInteger)countByEnumeratingWithState:(MutPtr<NSFastEnumerationState>)state
    ...
    // TODO: Use mutations_ptr. This implementation will only be safe for
    // arrays that don't mutate.
    // This was used as reference since the official docs are very vague about
