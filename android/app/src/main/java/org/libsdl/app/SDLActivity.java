// Note the only change in this file is on (or around) line 714 to increase
// the stack size of the SDL thread from the 1 MiB default to 16 MiB
// (primarily for debug builds).
