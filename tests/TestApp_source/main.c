...
int test_vsnprintf() {
  ...
  str = str_format("%f|%8f|%08f|%.f|%8.f|%.3f|%8.3f|%08.3f|%*f|%0*f", -10.12345,
                   -10.12345, -10.12345, -10.12345, -10.12345, -10.12345, -10.12345,
                   -10.12345, 8, -10.12345, 8, -10.12345);
  res += !!strcmp(str, "-10.123450|-10.123450|-10.123450|-10|     -10|-10.123| -10.123|-010.123|-10.123450|-10.123450");
  // Test %e
  ...
  str = str_format("%e|%8e|%08e|%.e|%8.e|%.3e|%8.3e|%08.3e|%*e|%0*e", -10.12345,
                   -10.12345, -10.12345, -10.12345, -10.12345, -10.12345, -10.12345,
                   -10.12345, 8, -10.12345, 8, -10.12345);
  res += !!strcmp(str, "-1.012345e+01|-1.012345e+01|-1.012345e+01|-1e+01|  -1e+01|-1.012e+01|-1.012e+01|-1.012e+01|-1.012345e+01|-1.012345e+01");
  // Test %g
  str = str_format("%g|%8g|%08g|%.g|%8.g|%.3g|%8.3g|%08.3g|%*g|%0*g", 10.12345,
                   10.12345, 10.12345, 10.12345, 10.12345, 10.12345, 10.12345,
                   10.12345, 8, 10.12345, 8, 10.12345);
  res += !!strcmp(str, "10.1235| 10.1235|010.1235|1e+01|   1e+01|10.1|    10.1|000010.1| 10.1235|010.1235");
  str = str_format("%g|%8g|%08g|%.g|%8.g|%.3g|%8.3g|%08.3g|%*g|%0*g", -10.12345,
                   -10.12345, -10.12345, -10.12345, -10.12345, -10.12345, -10.12345,
                   -10.12345, 8, -10.12345, 8, -10.12345);
  res += !!strcmp(str, "-10.1235|-10.1235|-10.1235|-1e+01|  -1e+01|-10.1|   -10.1|-00010.1|-10.1235|-10.1235");
  free(str);
