...
impl GuestFile {
    ...
    pub fn sync_all(&self) -> std::io::Result<()> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to sync a directory"),
        }
    }
    pub fn set_len(&self, len: u64) -> std::io::Result<()> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to resize a directory"),
        }
    }
}
...
impl Read for GuestFile {
    fn read(&mut self, buf: &mut [u8]) -> std::io::Result<usize> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to read from a directory"),
        }
    }
}
...
impl Write for GuestFile {
    fn write(&mut self, buf: &[u8]) -> std::io::Result<usize> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to write to a directory"),
        }
    }
    ...
    fn flush(&mut self) -> std::io::Result<()> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to flush a directory"),
        }
    }
}
...
impl Seek for GuestFile {
    fn seek(&mut self, pos: std::io::SeekFrom) -> std::io::Result<u64> {
        match self {
            ...
            GuestFile::Directory => panic!("Attempt to seek in a directory"),
        }
    }
}
