...
pub const ARRAYS: &[ArrayInfo] = &[
    ...
    ArrayInfo {
        ...
        buffer_binding: gles11::MATRIX_INDEX_ARRAY_BUFFER_BINDING_OES,
...
const GET_PARAMS: ParamTable = ParamTable(&[
    ...
    (
        gles11::MATRIX_INDEX_ARRAY_BUFFER_BINDING_OES,
        ParamType::Int,
        1,
    ),
    ...
    (gl21::MATRIX_PALETTE_ARB, ParamType::Boolean, 1),
...
impl GLES for GLES1OnGL2 {
    ...
    unsafe fn MatrixMode(&mut self, mode: GLenum) {
        assert!(
            mode == gl21::MODELVIEW
                || mode == gl21::PROJECTION
                || mode == gl21::TEXTURE
                || mode == gl21::MATRIX_PALETTE_ARB
        );
