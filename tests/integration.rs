...
fn run_c_test_app() -> Result<(), Box<dyn Error>> {
    // We want to use lld by default for this test, since this test is
    ...
    let extra_compile_args = [
        ...
        // support. Perhaps it's confused and thinks it's invoking Apple's
        // ld64? Telling it not to use newer flags like this seems to avoid
        // this, but I suspect there may be a better fix.
        "-mlinker-version=0",
    ];
