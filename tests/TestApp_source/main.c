...
int test_CGGeometry(void) {
  ...
  success = success && !(CGRectGetMinX(testRect) == testRect.origin.x && CGRectGetMinX(testRect) == 2.0);
  success = success && !(CGRectGetMaxX(testRect) == testRect.origin.x + testRect.size.width && CGRectGetMaxX(testRect) == 102.0);

  success = success && !(CGRectGetMinY(testRect) == testRect.origin.y && CGRectGetMinY(testRect) == 3.0);
  success = success && !(CGRectGetMaxY(testRect) == testRect.origin.y + testRect.size.height && CGRectGetMaxY(testRect) == 203.0);
