...
impl ObjC {
    ...
    pub fn register_bin_classes(&mut self, bin: &MachO, mem: &mut Mem) {
        ...
        // (https://github.com/apple-oss-distributions/objc4/blob/689525d556eb3dee1ffb700423bccf5ecc501dbf/runtime/objc-runtime-new.mm#L2433-L2481)
        if let Some(root_class) = root_class {
            let root_class_name = &self.borrow::<ClassHostObject>(root_class).name;
            // TODO: support other root classes?
            assert_eq!(root_class_name, "NSObject");
