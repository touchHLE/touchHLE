...
/// Opaque type that represents method of a class. Currently represented by combination of a class and a selector name.
pub(super) struct MethodRef(Class, SEL);
unsafe impl SafeRead for MethodRef {}

/// Standard Objective-C runtime function for getting an opaque pointer to a class instance method.
...
/// Standard Objective-C runtime function for getting a function pointer to a class instance method.
...
/// Standard Objective-C runtime function for replacing a class instance method with a custom implementation.
