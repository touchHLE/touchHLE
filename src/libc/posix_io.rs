...
fn fcntl(
    ...
    match cmd {
        ...
        F_RDADVISE => {
            log!("TODO: Ignoring F_RDADVISE for file descriptor {}", fd);
        }
        F_GETFD => {
            log!("TODO: Ignoring F_GETFD for file descriptor {}", fd);
        }
        F_SETFD => {
            log!("TODO: Ignoring F_SETFD for file descriptor {}", fd);
        }
        F_GETLK => {
            log!("TODO: Ignoring F_GETLK for file descriptor {}", fd);
        }
        F_SETLK => {
            log!("TODO: Ignoring F_SETLK for file descriptor {}", fd);
        }
        _ => {
